...
void MusicManager::SetMODMusicVolume(const std::string &name, const unsigned volume) {
	m_mod_musics[name].setMasterVolume(volume);
}
void MusicManager::SetOGGMusicVolume(const std::string &name, const unsigned volume) {
