...
const std::array<std::vector<SelectTileData>, 5> TilePage = {{
    ...
    { // PAGE 3
        ...
        {"GreenPiranhaGreenUp_0", CustomTileProperty(), sf::Vector2f(128, 0), sf::Vector2i(16, 22), sf::Vector2f(32.0f, 63.0f), 2, 1, 0, 0},
        ...
        {"GreenPiranhaGreenDown_0", CustomTileProperty(), sf::Vector2f(128, 32), sf::Vector2i(16, 10), sf::Vector2f(32.0f, 0.f), 2, 1, 0, 1},
        {"GreenPiranhaGreenRight_0", CustomTileProperty(), sf::Vector2f(128, 64), sf::Vector2i(22, 16), sf::Vector2f(63.0f, 32.0f), 2, 1, 0, 2},
        {"GreenPiranhaGreenLeft_0", CustomTileProperty(), sf::Vector2f(128, 96), sf::Vector2i(10, 16), sf::Vector2f(0.0f, 32.f), 2, 1, 0, 3},
    },
    { // PAGE 4
