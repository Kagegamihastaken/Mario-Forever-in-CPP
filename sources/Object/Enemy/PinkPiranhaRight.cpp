...
PinkPiranhaRight::PinkPiranhaRight(EnemyManager &manager, const sf::Vector2f &position)
    ...
    m_animation.setAnimationSequence("PINK_PIRANHA_RIGHT");
...
void PinkPiranhaRight::updatePreviousData() {
...
void PinkPiranhaRight::draw(float alpha) {
...
sf::Vector2f PinkPiranhaRight::getPosition() {
    return m_transform.getCurrentPosition();
}

sf::Vector2f PinkPiranhaRight::getOrigin() {
    return m_transform.getOrigin();
}

sf::FloatRect PinkPiranhaRight::getHitbox() {
    return m_hitbox;
}

bool PinkPiranhaRight::isDestroyed() {
