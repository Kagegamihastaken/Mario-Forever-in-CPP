...
void PinkPiranhaLeft::statusUpdate(float deltaTime) {
    ...
    if (fire) {
        ...
        AddPiranhaAIProjectile(static_cast<bool>(m_animation.getAnimationDirection()), PIRANHA_LEFT, PIRANHA_FIREBALL, getCurrentPosition().x + 51.f, getCurrentPosition().y);
    }
}
