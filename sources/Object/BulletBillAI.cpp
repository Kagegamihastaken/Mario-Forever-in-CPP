...
plf::colony<MFCPP::BulletBillAI> BulletBillList;
...
void DeleteBulletBillIndex(const plf::colony<MFCPP::BulletBillAI>::colony_iterator<false>& it) {
...
void AddBulletBill(const BulletType type, const float speed, const bool direction, const float x, const float y) {
    plf::colony<MFCPP::BulletBillAI>::colony_iterator<false> it;
    switch (type) {
        case BULLET_NORMAL:
