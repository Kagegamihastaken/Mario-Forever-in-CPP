...
void LuckyBlockFlower::updatePreviousData() {
...
void LuckyBlockFlower::statusUpdate(float deltaTime) {
...
void LuckyBlockFlower::draw(float alpha) {
...
sf::Vector2f LuckyBlockFlower::getPosition() {
    return m_transform.getCurrentPosition();
}

sf::Vector2f LuckyBlockFlower::getOrigin() {
    return m_transform.getOrigin();
}

sf::FloatRect LuckyBlockFlower::getHitbox() {
    return m_hitbox;
}

bool LuckyBlockFlower::isDestroyed() {
