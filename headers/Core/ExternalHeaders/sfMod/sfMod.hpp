...
public:
	...
	void setMasterVolume(unsigned int volume) const; // Range: 1-512

	void seekOrder(int order) const;

	// See bottom of file for more info on mixer callbacks
	void initMixerCallback(ModPlugMixerProc proc) const;
	void unloadMixerCallback() const;
