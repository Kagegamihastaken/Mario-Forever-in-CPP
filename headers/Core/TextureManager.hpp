...
public:
	...
	static void LoadingAnimatedTexture(std::string path, std::string name, int start, int end, int y, int sizex, int sizey);
	static void Loadingtexture(std::string path, std::string name, int x, int y, int sizex, int sizey, bool isRepeated = false);
};
