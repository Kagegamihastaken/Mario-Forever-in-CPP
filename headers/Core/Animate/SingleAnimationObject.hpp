...
namespace MFCPP {
    ...
    public:
        void setAnimation(uint32_t startingIndexAnimation, uint32_t endingIndexAnimation, uint8_t frequency = 50,
                          bool loop = false);

        void setRangeIndexAnimation(uint32_t startingIndexAnimation, uint32_t endingIndexAnimation,
