...
enum LuckyBlockAtt { LUCKY_COIN, LUCKY_MUSHROOM, LUCKY_FIRE_FLOWER, LUCKY_GREEN_MUSHROOM, LUCKY_BEETROOT};
...
//enum for Bullet
enum BulletType {BULLET_NORMAL, BULLET_NORMAL_FLIPPED, FIRE_LAUNCHER, FIRE_LAUNCHER_FLIPPED, FIRE_LAUNCHER_STAND};
