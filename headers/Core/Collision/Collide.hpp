...
extern bool isAccurateCollideBot(const MFCPP::CollisionObject& CollideObj, float offset, float& CurrPosXCollide, float& CurrPosYCollide, bool& NoAdd, unsigned ID);
...
extern bool CheckCollisionBot(const MFCPP::CollisionObject& CollideObj, float offset, float& CurrX, float& CurrY, bool& NoAdd, unsigned ID);
...
extern bool QuickCheckOnlyObstacleBotCollision(const MFCPP::CollisionObject& CollideObj, float offset, float& CurrX, float& CurrY, bool& NoAdd);
extern bool QuickCheckOnlyHittableBotCollision(const MFCPP::CollisionObject& CollideObj, float offset, float& CurrX, float& CurrY, bool& NoAdd);
...
extern bool QuickCheckBotCollision(const MFCPP::CollisionObject& CollideObj, float offset, float& CurrX, float& CurrY);
