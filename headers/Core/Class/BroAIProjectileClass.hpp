...
namespace MFCPP {
    ...
    public:
        ...
        explicit BroAIProjectile(bool direction, BroAIProjectileType type, BroAIProjectileBehavior behaviour, float xvelo, float yvelo, const sf::FloatRect& hitbox, const sf::Vector2f& pos, const sf::Vector2f& origin);
