#ifndef MFCPP_REDSPINY_HPP
#define MFCPP_REDSPINY_HPP

#include "Core/Animate/SingleAnimationObject.hpp"
#include "Core/Object/Enemy.hpp"
#include "Core/Object/Enemy/Identity/GoombaAIType.hpp"

class RedSpiny final : public MFCPP::Enemy, public MFCPP::GoombaAIType {
public:
    explicit RedSpiny(EnemyManager& manager, const sf::Vector2f& position);
    ~RedSpiny() override = default;
